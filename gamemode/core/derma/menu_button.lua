...
function menu_button:Paint(w, h)
    jericho.draw.Rounded(self.radius, 0, 0, w, h, self.bg_color, self.bg_border_color);
    jericho.draw.Rounded(self.radius, self.padding, self.padding, w - 2 * self.padding, h - 2 * self.padding, self.bg_color);
end
